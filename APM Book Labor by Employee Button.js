    ...
    function injectUI() {
        ...
        if (woInput && !document.getElementById('tm-copy-wo-btn')) {
            ...
            if (woLabel) {
                ...
                cBtn.innerText = '📋 Copy';
                cBtn.style = "margin-left:5px; padding:1px 4px; cursor:pointer; font-size:10px; background:#ff9900; border:1px solid #a88734; border-radius:3px; vertical-align:middle;";
